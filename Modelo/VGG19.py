...
VGG19_base_model = VGG19(weights='imagenet', include_top=False) # include_top=False excludes final FC layer
...
# Define trainable model which links input from the VGG19 base model to the new classification prediction layers
...
# Freeze all layers in the VGG19 base model
...
model.save('vgg19-transfer-learning.model')

# Option2: Transfer Learning with Fine-Tuning - retrain the end few layers (called the top layers) of the vgg19 model
...
model.save('vgg19-fine-tune.model')
