...
Xception_base_model = Xception(weights='imagenet', include_top=False) # include_top=False excludes final FC layer
...
# Freeze all layers in the Xception base model
...
model.save('xception-transfer-learning.model')

# Option2: Transfer Learning with Fine-Tuning - retrain the end few layers (called the top layers) of the xception model
...
model.save('xception-fine-tune.model')
